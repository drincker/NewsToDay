...
import com.whatrushka.impl.appbookmarks.AppArticlesServiceImpl
import com.whatrushka.impl.appbookmarks.models.ArticleSerializer
...
val appConfigModule = module {
    ...
    single<ArticleSerializer> { ArticleSerializer() }
    single<AppArticlesService> { AppArticlesServiceImpl(get(), get()) }
}